...
<div class="contact-page-container">
  <div class="flex">
    <div class="left">
      ...
      <div class="contact-second-header">
        <p>
          Реквизиты:
        </p>
      </div>
      ...
      <div class="contact-description">
        <p>
          Директор Юрковец Александр Николаевич: 1-я среда месяца с 14:00 до 15:00.<br>
          Предварительная запись на приём осуществляется по телефону: 250-250<br>
          Запись на приём осуществляется не позднее, чем за день до приема.<br>
        </p>
      </div>
    ...
    <div class="right">
      <div class="flex-container">
       ...
       <div class="row-contact">
        <div class="inst-info">
          <a href="https://www.instagram.com/u_dent.by/" class="inst-svg" target="_blank">
